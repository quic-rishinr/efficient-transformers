...
"""Detailed memory profiling harness for qwen3_vl_moe_layerwise_decode.py."""
...
TARGET_SCRIPT = REPO_ROOT / "examples/image_text_to_text/models/qwen3_vl_moe/qwen3_vl_moe_layerwise_decode.py"
DEFAULT_HF_HUB_CACHE = "/home/huggingface_hub"
DEFAULT_QEFF_HOME = "/home/rishinr/qwen3vl_235b_2layer_layerwise_decode_profile"
...
from profile_qwen3_5_moe_layerwise_decode import (  # noqa: E402
    DetailedProfiler,
    QEffMemoryProfiler,
...
def parse_args() -> argparse.Namespace:
    run_id = datetime.now().strftime("qwen3_vl_235b_2layer_layerwise_decode_%Y%m%d_%H%M%S")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"Detailed Qwen3-VL-MoE layerwise decode profiling elapsed time: {elapsed:.1f}s")
